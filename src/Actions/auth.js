...
export const loadUser = () => async dispatch =>{
    ...
    try {
        const res = await axios.get('https://highway-client-server.onrender.com:10000/auth')
        dispatch({
            type: USER_LOADED,
            payload: res.data
        })
...
export const register = ({fullName, userName, email, userPassword, userNumber}) => async dispatch => {
    ...
    try{
        const res = await axios({ 
            method: 'post',
            url: 'https://highway-client-server.onrender.com:10000/user/signup',
            data: body,
            headers: {
...
export const loginAuth = (email, userPassword) => async dispatch => {
    try{
        ...
        const res = await axios({ 
            method: 'post',
            url: 'https://highway-client-server.onrender.com:10000/auth',
            data: body,
            headers: {
                "Content-Type": "application/json",
            },
